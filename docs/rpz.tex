...
\titleformat{\section}
{\normalsize\fontsize{20}{23}\bfseries}{\thesection}{1em}{}
%\titlespacing\section{\parindent}{\parskip}{\parskip}
\titleformat{name=\section,numberless}
{\normalsize\fontsize{20}{23}\filcenter\bfseries}{}{0em}{}

\titleformat{\subsection}[hang]
{\normalsize\fontsize{17}{20}\bfseries}{\thesubsection}{1em}{}
...
%
\titleformat{\chapter}
{\normalsize\fontsize{20}{23}\filcenter\bfseries}{\thechapter}{1em}{}
...
\captionsetup[table]{singlelinecheck=false, justification=raggedright, labelsep=endash}
...
\begin{document}
	\begin{titlepage}
		...
		\begin{table}[h!]
			...
			\begin{signstabular}[0.55]{p{7.25cm} >{\centering\arraybackslash}p{4cm} >{\centering\arraybackslash}p{4cm}}
				Нормконтролер & \uline{\mbox{\hspace*{4cm}}} & \uline{\hfill Д. Ю. Мальцева \hfill} \\
				& \scriptsize (Подпись, дата) & \scriptsize (И.О. Фамилия)
			\end{signstabular}
		\end{table}
